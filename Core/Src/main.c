...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LOWERLIMIT_ACT1_Pin START_BUTTON_Pin STOP_BUTTON_Pin UPPERLIMIT_ACT3_Pin
                           UPPERLIMIT_ACT2_Pin LOWERLIMIT_ACT3_Pin LOWERLIMIT_ACT2_Pin */
  GPIO_InitStruct.Pin = LOWERLIMIT_ACT1_Pin|START_BUTTON_Pin|STOP_BUTTON_Pin|UPPERLIMIT_ACT3_Pin
                          |UPPERLIMIT_ACT2_Pin|LOWERLIMIT_ACT3_Pin|LOWERLIMIT_ACT2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);

  /*Configure GPIO pin : UPPERLIMIT_ACT1_Pin */
  GPIO_InitStruct.Pin = UPPERLIMIT_ACT1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(UPPERLIMIT_ACT1_GPIO_Port, &GPIO_InitStruct);
